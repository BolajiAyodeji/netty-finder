...
function compute(ev) {
  ...
  var userInput = Number(userInput); //Converts number to GSM acceptable Prefixes

  var checkNumber = userInput.toString().slice(0, 3);
  var checkNumber = 0 + checkNumber;
  var checkNumber2 = userInput.toString().slice(0, 4);
  var checkNumber2 = 0 + checkNumber2; //Checks validity of number, (must start with 0)

  var checkValid = userInput.toString().slice(0);
  var checkValid = 0 + checkValid; //Stores initial number

  var iInput = userInput.toString().slice(0);
  var iInput = 0 + iInput; //Returns output of the converter
  ...
  var myResult2 = validate(userInput); //Stores GSM Prefixes

  var gPrefixes = function gPrefixes(GSM) {
    this.GSM = GSM;
  }; //MTN GSM Prefixes
  ...
  var m9 = new gPrefixes('0706'); //GLO GSM Prefixes
  ...
  var a7 = new gPrefixes('0907'); //STARCOMMS GSM Prefixes

  var s1 = new gPrefixes('07028');
  var s2 = new gPrefixes('07029');
  var s3 = new gPrefixes('0819'); //VISAFONE GSM Prefixes

  var v1 = new gPrefixes('07025');
  var v2 = new gPrefixes('07026');
  var v3 = new gPrefixes('0704'); //MULTILINKS GSM Prefixes

  var mu1 = new gPrefixes('07027');
  var mu2 = new gPrefixes('0709'); //ZOOM GSM Prefix

  var z1 = new gPrefixes('0707'); //NTEL GSM Prefix

  var nt1 = new gPrefixes('0804'); //SMILE GSM Prefix

  var sm1 = new gPrefixes('0702'); //Validates number and detects network
...
//# sourceMappingURL=bolaji.js.map